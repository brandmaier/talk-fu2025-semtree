...
style_extra_css(css = list(
  ".title" = list(background-image="url(\"unsplash/arthur-hinton-6YDn7__tato-unsplash.jpg\")"),
...
# Recent Extensions - CT-SEM Forests (Cont'd)

- relatively large type-I error rates in some conditions
- variable importance estimates remain robust
- excessive runtimes, e.g. study 1: `r 64*14.3` min for the forest and `r 64*0.6` min for the variable importance estimates (`N=1,000, 4 repeated measures, 15 predictors)
